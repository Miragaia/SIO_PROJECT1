...
VALUES
    ...
    ('DETIP Hat', 'Stylish hat with the DETIP logo embroidered.', 12.99, 200, 2, 'images/emblema_lei.png'),
	('DETI T-shirt', 'Official DETI T-shirt with the department logo.', 19.99, 100, 1, 'images/emblema_lei.png'),
    ('DETI Mug', 'Coffee mug featuring the DETI branding.', 9.99, 150, 2, 'images/emblema_lei.png'),
    ('DETI Backpack', 'Stylish backpack with multiple compartments for your tech gear.', 39.99, 50, 3, 'images/emblema_lei.png'),
    ('DETI Sweatshirt', 'Warm and comfortable DETI Sweatshirt for the winter season.', 29.99, 75, 1, 'images/emblema_lei.png'),
    ('DETI Mousepad', 'High-quality mousepad with a DETI design.', 7.99, 200, 4, 'images/emblema_lei.png'),
    ('DETI USB Drive', 'Custom DETI-themed USB drive for your data storage needs.', 12.99, 100, 5, 'images/emblema_lei.png'),
    ('DETI Notebook', 'Spiral-bound notebook with DETI branding for your notes.', 6.99, 150, 6, 'images/emblema_lei.png'),
    ('DETI Poster', 'Decorate your room with a DETI poster featuring iconic images.', 8.99, 50, 7, 'images/emblema_lei.png');
